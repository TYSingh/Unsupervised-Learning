...
lastfm <- read.csv("C:/Users/User/Desktop/14 Jan/lastfm_Female.csv")

#Data Exploration Starts
lastfm[1:19,]
length(lastfm$user) #  78132 records in the file
lastfm$user <- factor(lastfm$user)
length(levels(lastfm$user))   #3851 users
...
playlist[1:2] ## The first two listeners (1 and 19 users) listen to the displayed artists
